...
const facts = [
  { label: 'Base', value: aboutContent.location, icon: MapPin, tone: 'text-[var(--aka)]' },
  { label: 'Study', value: aboutContent.education, icon: GraduationCap, tone: 'text-[var(--ai)]' },
  { label: 'Company', value: 'Codezela Technologies', icon: Buildings, tone: 'text-[var(--murasaki)]' },
  { label: 'Parallel practice', value: 'Music production', icon: Waveform, tone: 'text-[var(--matcha)]' },
];
      ...
      <div className="mx-auto grid w-full max-w-[1500px] grid-cols-1 gap-24 px-5 sm:px-8 lg:grid-cols-[0.82fr_1.18fr] lg:px-10 xl:gap-28">
        ...
        <div className="space-y-24">
          ...
          >
            ...
            <p className="text-lg leading-8 text-[var(--muted)]">{aboutContent.bio}</p>
          </motion.div>
